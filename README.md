...
# 0247springboot校园资产管理

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1jqaLe1EbH?p=17)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本校园资产管理也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让考试信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，校园资产管理的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，校园资产管理是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此校园资产管理为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图，管理员在后台主要管理资产等。
...
![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\用户.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\用户.jpg")
图4.1 用户实体属性图

（2）下图是校园资产实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\校园资产.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\校园资产.jpg")
图4.2 校园资产实体属性图

（3）下图是资产维修实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\资产维修.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\资产维修.jpg")
图4.3 资产维修实体属性图

（4）下图是资产借用实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\资产借用.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\资产借用.jpg")
图4.4 资产借用实体属性图

（5）下图是入库实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\入库.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\入库.jpg")
图4.5 入库实体属性图

（6）下图是资产报废实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\资产报废.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\资产报废.jpg")
图4.6 资产报废实体属性图

（7）下图是入库详情实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\xiaoyuanzichan\入库详情.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\xiaoyuanzichan\入库详情.jpg")
图4.7 入库详情实体属性图
### 4.3.2 数据库表结构设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shangpin\_id|Integer|校园资产|是|
|3|baofei\_number|Integer|报废数量|是|
|4|baofei\_content|String|报废备注|是|
|5|insert\_time|Date|报废时间|是|
...
|3|shangpin\_id|Integer|校园资产|是|
|4|jieyong\_number|Integer|借用数量|是|
|5|jieyong\_content|String|借用备注|是|
|6|guihuan\_types|Integer|是否归还|是|
|7|insert\_time|Date|借用时间|是|
|8|create\_time|Date|创建时间|是|
表4.4校园资产表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shangpin\_uuid\_number|String|资产编号|是|
|3|shangpin\_name|String|资产名称|是|
|4|shangpin\_photo|String|资产照片|是|
|5|shangpin\_types|Integer|资产类型|是|
|6|didian\_types|Integer|存放地点|是|
|7|shangpin\_kucun\_number|Integer|资产库存|是|
|8|shangpin\_delete|Integer|逻辑删除|是|
|9|shangpin\_content|String|资产介绍|是|
...
|3|shangpin\_churu\_inout\_name|String|入库名称|是|
|4|shangpin\_churu\_inout\_types|Integer|入库类型|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shangpin\_churu\_inout\_id|Integer|入库|是|
|3|shangpin\_id|Integer|校园资产|是|
|4|shangpin\_churu\_inout\_list\_number|Integer|入库数量|是|
...
|1|Id|Int|id|否|
|2|shangpin\_id|Integer|校园资产|是|
|3|weixiu\_number|Integer|维修数量|是|
|4|weixiu\_content|String|维修备注|是|
|5|insert\_time|Date|维修时间|是|
|6|create\_time|Date|创建时间|是|
表4.8用户表
